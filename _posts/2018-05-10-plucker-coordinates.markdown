...
-----这么理解是不是很复杂，那么我介绍一种简单的理解，上面的线的表达式可以退化为(<b>d</b>:<b>m</b>)，假设直线上有两个点p<sub>1</sub>和p<sub>2</sub>则<b>d</b> = p<sub>2</sub> - p<sub>1</sub>, <b>m</b> =  p<sub>1</sub> x p<sub>2</sub>。将 p<sub>1</sub>和p<sub>2</sub> 看作从(0,0,0)出发的两条线段。这样理解<b>d</b>可以筛选出系列的线段，可以看作绕着原点，方向为朝向屏幕的直线集合，如下图所示。<b>m</b>的作用就是唯一能确定一条线段垂线方向与其相同。这样空间中的直线就能被唯一确定下来。<br>
![线的普吕克坐标系的理解](/img/in-post/plucker/line.jpg)</br>
...
其实有平面方程的就很好理解，平面方程的系数就是上诉的<b>a</b>。
...
![ai的定义](/img/in-post/plucker/line-line-meet.jpg)<br>
